...
class ActorNetwork(object):
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate):
        ...
        self.obj = tf.reduce_sum(tf.multiply( # cross-entropy loss function
    ...
    def create_actor_network(self):
        with tf.variable_scope('actor'):
            ...
            split_2 = tflearn.conv_1d(inputs[:, 0:1, :], 128, 4, activation='relu')
            split_3 = tflearn.conv_1d(inputs[:, 1:2, :], 128, 4, activation='relu')
            split_4 = tflearn.conv_1d(inputs[:, 2:, :A_DIM], 128, 4, activation='relu')
            split_5 = tflearn.fully_connected(inputs[:, 2:, -1], 128, activation='relu')
